...
describe('campaign-daily-anchor', () => {
  ...
  it('primary index is deterministic from hash', () => {
    const order1 = anchorFallbackOrder('camp1', '2025-06-01', 'campaign_daily_v1', ['u1', 'u2', 'u3']);
    const order2 = anchorFallbackOrder('camp1', '2025-06-01', 'campaign_daily_v1', ['u1', 'u2', 'u3']);
