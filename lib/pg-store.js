...
const USER_PROFILE_SELECT =
  'id, handle, display_name, email, discoverable, show_in_feed, bio, avatar_url, discoverable_as, looking_for, chart_highlights, created_at, updated_at';
const USER_PROFILE_SELECT_LEGACY =
  'id, handle, display_name, email, discoverable, show_in_feed, bio, avatar_url, discoverable_as, looking_for, created_at, updated_at';
