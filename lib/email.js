...
function buildPasswordResetEmail(resetUrl) {
  ...
  const subject = 'Reset your Astradio password';
  const html = `<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>
<body style="margin:0;padding:0;background:#f6f8f7;font-family:Georgia,'Times New Roman',serif;color:#1a1a1a;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f6f8f7;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#ffffff;border-radius:12px;border:1px solid #e5ebe8;padding:32px 28px;">
        ...
        <tr><td style="padding-bottom:20px;">
          <p style="margin:0 0 12px;font-size:18px;line-height:1.5;color:#1a1a1a;">Reset your password</p>
          <p style="margin:0;font-size:15px;line-height:1.6;color:#444;">Use the link below to choose a new password. This link expires in 1 hour.</p>
        </td></tr>
        <tr><td style="padding:8px 0 24px;">
          <a href="${url}" style="display:inline-block;background:${ACCENT};color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:12px 24px;border-radius:8px;">Reset password</a>
        </td></tr>
        <tr><td style="padding:0 0 16px;">
          <p style="margin:0;font-size:12px;line-height:1.5;color:#777;">Or copy this link into your browser:</p>
          <p style="margin:8px 0 0;font-size:12px;line-height:1.5;color:#444;word-break:break-all;">${url}</p>
        </td></tr>
        <tr><td style="padding-top:16px;border-top:1px solid #e5ebe8;">
          <p style="margin:0;font-size:12px;line-height:1.5;color:#777;">If you did not request a password reset, you can ignore this email.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
