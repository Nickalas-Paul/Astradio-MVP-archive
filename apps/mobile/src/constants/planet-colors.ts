/** Copied from apps/web/src/core/planet-identity.ts — muted jewel tones on dark backgrounds. */
...
export function planetColor(planetName: string): string | undefined {
  return PLANET_COLORS[normalizePlanetName(planetName)];
}
