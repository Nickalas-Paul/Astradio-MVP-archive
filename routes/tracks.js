...
const { authenticateToken, optionalAuth, checkRateLimit } = require('../lib/authentication');
const { getRow, getRows, insert, update, remove } = require('../lib/database');
const { generateChartHash, uploadTrackAudio, uploadTrackPreview, uploadOGImage } = require('../lib/storage');
const redis = require('../lib/redis');

const router = express.Router();

// Validation middleware
const validateRenderRequest = [
...
router.post('/render', validateRenderRequest, authenticateToken, async (req, res) => {
  try {
